...
defineOptions({
    layout: {
        breadcrumbs: [
            ...
            { title: 'Kho', href: logistics.warehouses.index() },
        ],
    },
});
</script>
...
<template>
    ...
    <div class="flex h-full flex-1 flex-col gap-4 p-4">
        <div class="flex items-center justify-between">
            <h1 class="text-2xl font-bold">Kho hàng</h1>
        </div>
                ...
                <CardContent>
                    <div class="grid grid-cols-2 gap-4">
                        <div class="text-center">
                            ...
                            <div class="text-xs text-muted-foreground">Kiện hàng</div>
                        </div>
                        <div class="text-center">
                            <div class="text-2xl font-bold text-amber-500">{{ warehouse.scans_today ?? 0 }}</div>
                            <div class="text-xs text-muted-foreground">Lượt quét hôm nay</div>
                        </div>
                    </div>
